...
Modern software and mobile applications have shaped my **mental model** pertaining to dealing with multiple instances of an object. My DraftKings experience has not aligned with what I have come to expect: to be able to modify, “delete”, or distinguish the differences of multiple instances of an object.
